...
public class TwoStageColoring extends TwoStage {
	 ...
	 */
	public TwoStageColoring(int times, int firstStage, int sp) {
		super(firstStage, sp);
		this.times = times;
		this.slack = sp;
	...
	public String getName() {
		return new String("TwoStageColoring-" + this.times + "-times-" + this.slack + "-slack");
	}
